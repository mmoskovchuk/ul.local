        ...
        <nav id="nav">
            ...
            <?php elseif ( $my_lang == 'ru' ) : ?>
                ...
                <ul>
                    ...
                    <li><a href="/revolutions" class="link-to-page">Украинские революции</a></li>
                    <li><a href="/ru/novosty" class="link-to-page">Новости</a></li>
                    <li><a href="/interview" class="link-to-page">Интервью</a></li>
                    <li><a href="/books" class="link-to-page">Книги</a></li>
                </ul>
            ...
            <?php elseif ( $my_lang == 'en' ) : ?>
                ...
                <ul>
                    ...
                    <li><a href="/revolutions" class="link-to-page">Ukrainian Revolutions</a></li>
                    <li><a href="/en/news" class="link-to-page">News</a></li>
                    <li><a href="/interview" class="link-to-page">Interview</a></li>
